                ...
                <div class="card-table">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-center table-hover datatable" id="customer_list_table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{ url('/customerprofile/'.base64_encode($user->id)) }}"
                                                    class="avatar avatar-md me-2"><img class="avatar-img rounded-circle"
                                                        src="{{asset('/public/uploads/profile/'.$user->comp_logo)}}"
                                                        alt=""></a>
                                                <a href="{{ url('/customerprofile/'.base64_encode($user->id)) }}">{{
                                                    $user->comp_name }} <span><span>{{ $user->comp_email
                                                            }}</span></span></a>
                                            </h2>
                                        </td>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <a href="{{ url('/messages/'.base64_encode($user->id)) }}"
                                                class="btn btn-greys me-2"><i class="fe fe-send me-1"></i> Message</a>
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul>
                                                        ...
                                                        @if ($user->status==0)
                                                        <li>
                                                            <a data-id="{{$user->id}}" data-stat="1"
                                                                class="dropdown-item caStatus"
                                                                href="javascript:void(0);"><i
                                                                    class="fa-solid fa-power-off me-2"></i>Active</a>
                                                        </li>
                                                        @else
                                                        <li>
                                                            <a data-id="{{$user->id}}" data-stat="0"
                                                                class="dropdown-item caStatus"
                                                                href="javascript:void(0);"><i
                                                                    class="far fa-bell-slash me-2"></i>InActive</a>
                                                        </li>
                                                        @endif
                                                    </ul>
                                                </div>
        ...
        <div class="sidebar-body">
            <form action="#" autocomplete="off">
                <div class="accordion" id="accordionMain1">
                    ...
                    <button id="resetBtnCustomer" class="btn btn-secondary">Reset</button>
...
<script>
    $(document).ready(function() {
        ...
        $('#resetBtnCustomer').on('click', function(event) {
