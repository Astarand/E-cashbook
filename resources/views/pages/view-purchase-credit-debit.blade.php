        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="content-page-header">
                    <h5>View Purchase Credit Debit Note</h5>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-lg-6">
                    ...
                    <input type="text" class="form-control" name="inv_num" id="inv_num" value="{{ $sales->inv_num }}" required="">
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="seller_contact" id="seller_contact" value="{{ $sales->seller_contact }}" class="form-control" placeholder="Contact Number">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label>Email Address</label>
                                                <input type="text" name="seller_email" id="seller_email" value="{{ $sales->seller_email }}" class="form-control" placeholder="Email Address">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label>Address Line 2</label>
                                                <input type="text" name="seller_addtwo" id="seller_addtwo"  value="{{ $sales->seller_addtwo }}" class="form-control" placeholder="Address Line 2">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label>Pincode</label>
                                                <input type="text" name="seller_pin" id="seller_pin" value="{{ $sales->seller_pin }}" class="form-control" placeholder="Pincode">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label>Contact Person Name</label>
                                                <input type="text"  name="contact_name" id="contact_name" value="{{ $sales->contact_name }}" class="form-control" placeholder="Contact Person Name">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            <div class="form-group ">
                                                <label>Contact Person Number</label>
                                                <input type="text"  name="contact_num" id="contact_num" value="{{ $sales->contact_no }}" class="form-control" placeholder="Contact Person Number">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                        <div class="input-block mb-0">
											...
											@if(@$sales->voucher_doc !="")
												<div class="downloadFile pb-3"><a target="_blank" href="{{ asset('/public/uploads/purchase-credit-debit/'.$sales->voucher_doc) }}">Download</a></div>
											@endif
                                        </div>
                                    </div>
                                </div>
