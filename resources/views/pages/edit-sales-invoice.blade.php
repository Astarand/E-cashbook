                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12" id="billing_input" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="prod_gov_fee" id="prod_gov_fee" value="0" class="form-control" placeholder="Enter Fees Amount">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group ">
                                        <label>HSN / SAC Code<span class="text-danger">*</span></label>
                                        <input type="text" name="hsn_sac_code" id="hsn_sac_code" class="form-control" placeholder="HSN / SAC Code" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>GST Rate<span class="text-danger">*</span></label>
                                        <input type="text" name="gst_rate" id="gst_rate" class="form-control" Value="" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12 my-auto">
                                    <a href="javascript:void(0);" onclick="addProductItems()" class="btn btn-primary w-100"> Save Data</a>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12 my-auto">
