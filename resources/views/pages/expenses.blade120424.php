                            ...
                            <div class="tab-content">
                                <div class="tab-pane active show" id="day" role="tabpanel">
                                    ...
                                    <div class="col-sm-12 pb-4 d-flex justify-content-end">
                                        <a class="btn btn-primary" href="addexpenses"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add new Expense</a>
                                    </div>
									@endif
                                    <div class="col-sm-12">
                                            ...
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-center table-hover datatable">
                                                        ...
                                                        <tbody>
														<?php $j = 1; ?>
														@foreach ($monthWiseExpenses as $monthWise)
                                                        <tr>
                                                            <td><?php echo $i++; ?></td>                                                            
                                                            <td>{{ date('M-Y', strtotime($monthWise->month)) }}</td>
                                                            <td><i class="fa-solid fa-indian-rupee-sign"></i>&nbsp; {{ $monthWise->expense_amt }}</td>
															<td>{{ $monthWise->comp_name }}</td>
                                                            <td class="d-flex align-items-center">
                                                                <a href="{{ url('/viewmonthexpenses/'.base64_encode($monthWise->month).'/'.base64_encode($monthWise->added_by)) }}" class="btn btn-greys me-2"><i class="fa fa-eye me-1"></i> View</a>
                                                            </td>
                                                        </tr>
														@endforeach
                                                        </tbody>
