                ...
                <div class="content-page-header">
                    ...
                    <div class="list-btn">
                        <ul class="filter-list">
                            ...
                            <li>
                                <a class="btn btn-primary" href="{{ url('/adddesignation') }}"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add Employee</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a></a>
                                            <a href="profile.html">John Smith <span><span class="__cf_email__" data-cfemail="a9c3c6c1c7e9ccd1c8c4d9c5cc87cac6c4">[email&#160;protected]</span></span></a>
                                        </h2>
                                    </td>
