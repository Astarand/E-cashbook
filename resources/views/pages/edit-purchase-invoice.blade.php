                            ...
                            <div class="row mb-4">
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <select class="form-select" name="prod_type" id="prod_type" onChange="changeProductType()">
                                                <option value="">Select</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group row mb-0">
                                                <input type="text" class="form-control" name="disc_sell" id="disc_sell" aria-label="" placeholder="Discount">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 my-auto">
                                    <a href="javascript:void(0);" onclick="addProductItems_purchase()" class="btn btn-primary w-100"> Save Data</a>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 my-auto">
                                    <a href="javascript:void(0);" onclick="addAnotherProduct()" class="btn btn-outline-secondary w-100"> Add Another Product</a>
                                </div>
                            </div>
                                                        ...
                                                        <table class="table table-center table-hover datatable">
															...
															<tr>
																...
																<td class="d-flex align-items-center">
																	<a href="javascript:void(0);" data-id="{{ $value->id }}" data-sid="{{ $value->sid }}" data-rate="{{ $value->rate }}" data-discamt="{{ $value->disc_amt }}" data-taxtype="{{ $value->tax_type }}" onclick="editItemPurchase(this)" class="btn-action-icon me-2" data-bs-toggle="modal" data-bs-target="#add_discount"><span><i class="fe fe-edit"></i></span></a>
																	<a href="javascript:void(0);" data-id="{{ $value->id }}" data-sid="{{ $value->sid }}" onclick="delItemPurchase(this)" class="btn-action-icon" data-bs-toggle="modal" data-bs-target="#delete_discount"><span><i class="fe fe-trash-2"></i></span></a>
																</td>
															</tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                                <a href="#" data-bs-dismiss="modal" id="delItemPurchase" class="btn btn-primary paid-continue-btn">Delete</a>
                            </div>
                            <div class="col-6">
