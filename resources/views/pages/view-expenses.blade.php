                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label>Date</label>
                                    <input type="Date" name="expense_date" id="expense_date" value="{{ $expenses->expense_date }}" class="form-control" placeholder="Enter Date">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label>Purpose Of Expenses</label>
                                    <input type="text" name="pur_of_expense" id="pur_of_expense" value="{{ $expenses->pur_of_expense }}" class="form-control" placeholder="Enter Purpose Of Expenses">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    <select class="form-select" name="expense_cat"  id="expense_cat" >
                                        <option value="">Select</option>
                                        <option value="personnel" <?php echo ($expenses->expense_cat=='personnel')? "selected":"" ?>>Personnel Costs</option>
                                        <option value="cogs" <?php echo ($expenses->expense_cat=='cogs')? "selected":"" ?>>Cost of Goods Sold (COGS)</option>
                                        <option value="operating" <?php echo ($expenses->expense_cat=='operating')? "selected":"" ?>>Operating Expenses</option>
                                        <option value="taxes" <?php echo ($expenses->expense_cat=='taxes')? "selected":"" ?>>Taxes</option>
                                        <option value="interest" <?php echo ($expenses->expense_cat=='interest')? "selected":"" ?>>Interest Expenses</option>
                                        <option value="misc" <?php echo ($expenses->expense_cat=='misc')? "selected":"" ?>>Miscellaneous</option>
                                        <option value="other" <?php echo ($expenses->expense_cat=='other')? "selected":"" ?>>Other Income/Revenues</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label>Amount</label>
                                    <input type="text"  name="expense_amt" id="expense_amt" value="{{ $expenses->expense_amt }}" class="form-control" placeholder="Enter Expense Amount">
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label>Message</label>
                                    <input type="text" name="expense_msg" id="expense_msg" value="{{ $expenses->expense_msg }}" class="form-control" placeholder="Enter Message">
                                </div>
                            </div>
                        </div>
                    </div>
