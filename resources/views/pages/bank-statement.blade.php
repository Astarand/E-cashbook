                        ...
                        <div class="card-body">
                                ...
                                <div class="dash-count">
                                    <div class="dash-title">
										<h4>{{ $bank->bank_name }} 
											...
											<a class="active btn-filters" href="{{ url('/edit-bank/'.base64_encode($bank->id)) }}"> <span><i class="fe fe-edit me-1"></i></span></a>
											@endif
										</h4>
									</div>
                                    <div class="dash-counts mt-1">
                                        <div class="row">
                                            <div class="col-6 pt-1"><p> <strong>Applicant Name:</strong> {{ $bank->accholder_name }}</p></div>
                                            <div class="col-6 pt-1"><p> <strong>Bank Account Number:</strong> {{ $bank->bank_ac_no }}</p></div>
                                            <div class="col-6 pt-1"><p> <strong>Banking Unit Code:</strong> {{ $bank->ifsc_code }}</p></div>
                                            <div class="col-6 pt-1"><p><strong>Branch:</strong> {{ $bank->bank_branch }}</p></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-4 mt-2 text-center" style="border-right:1px solid #ddd;">
                                    ...
                                    <h6 class="text-muted mt-1 mb-0"><i class="fa-solid fa-indian-rupee-sign me-1"></i>{{ $bank->curr_bal }}</h6>
                                </div>
                                <div class="col-4 mt-2 text-center" style="border-right:1px solid #ddd;">
                ...
                <div class="card-body">
                    <div class="col-sm-12 pb-4 d-flex justify-content-end">
                        <div class="list-btn">
                            ...
                            <ul class="filter-list">
                                <li>
                                    <a class="btn btn-primary" href="{{ url('/add-bank-transaction/'.base64_encode($bank->id)) }}"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add new transaction</a>
                                </li>
                            </ul>
							@endif
                        </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-center table-hover datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="bg-success-light">
                                                ...
                                                <td><i class="fa-solid fa-indian-rupee-sign"></i>&nbsp; {{ $val->tran_amt }}</td>
                                                <td>{{ $val->purpose }}</td>
                                                <td class="d-flex align-items-center">
                                                    <a href="{{ url('/view-bank-transaction/'.base64_encode($val->id)) }}" class="btn btn-greys me-2"><i class="fa fa-eye me-1"></i> View</a>
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ url('/edit-bank-transaction/'.base64_encode($val->id)) }}"><i class="far fa-edit me-2"></i>Edit</a>
                                                                </li>
                                                                <li>
									...
									<div class="d-flex justify-content-center">
										<?php echo $bank_trans_pagination->links() ?>
									</div>
                                </div>
                            </div>
                        </div>
