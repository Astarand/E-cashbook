                ...
                <div class="content-page-header">
                    ...
                    <div class="list-btn">
                        <ul class="filter-list">
                            ...
                            <li>
                                <a class="btn btn-primary" href="add-online-order"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Create Order</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable">
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td><strong>OrderNO001</strong></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td><strong>OrderNO002</strong></td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a></a>
