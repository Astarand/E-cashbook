                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-center table-hover datatable">
                                                        ...
                                                        <tr>
															...
															<td>{{ $val->purpose_of_payment }}</td>                                                            
                                                            <td>{{ $val->mode_of_payment }}</td>
                                                            <td>{{ $val->payment_type }}</td>
                                                            <td>{{ $val->amount }}</td>                                                          
                                                            <td>{{ $val->message }}</td>
                                                            <td class="d-flex align-items-center">
                                                                <a href="{{ url('/view-payment/'.base64_encode($val->id)) }}" class="btn btn-greys me-2"><i class="fa fa-eye me-1"></i> View</a>
                                                                <div class="dropdown dropdown-action">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul>
                                                                            ...
                                                                            <li>
                                                                                <a class="dropdown-item" href="{{ url('/edit-payment/'.base64_encode($val->id)) }}"><i class="far fa-edit me-2"></i>Edit</a>
                                                                            </li>
                                                                            <li>
                                                                                <a class="dropdown-item paymentdelete" data-id="{{$val->id}}" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="far fa-trash-alt me-2"></i>Delete</a>
                                                                            </li>
																			@endif
                                                                        </ul>
                                                                    </div>
													...
													<div class="d-flex justify-content-center">
														<?php echo $payment_pagination->links() ?>
													</div>
                                                </div>
                                            </div>
                                        </div>
