       ...
       <section class="banner-sec d-flex align-items-center">
			...
			<div class="container">
				<div class="row justify-content-center">
					...
					<div class="logInner">
						<div class="logInnerBox">
							<div class="banner-lft text-center m-b-20">
								@if($flag==1)
								<p><img src="{{ asset('public/home-assets/images/chk.png') }}" alt=""> Email successfully verified!.</p>
								@else
								<p><img src="{{ asset('public/home-assets/images/chk.png') }}" alt=""> Email Already verified!.</p>
								@endif
							</div>
							
							 <p>Thank you for verifying your email and details.You can start access by login. </p>
								<center><a class="logRegBtn" href="{{ url('/') }}">Go to Home</a></center>
						</div>
					</div>
