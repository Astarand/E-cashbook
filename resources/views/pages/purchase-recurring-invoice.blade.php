        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="content-page-header">
                    <h5>Purchase Recurring Invoice</h5>
                    <div class="list-btn">
                        <ul class="filter-list">
                            ...
                            <li>
                                <a class="btn btn-primary" href="add-sales-recurring-invoice"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Create Invoice</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable">
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td><strong>INVNo001</strong></td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a></a>
                                                <a href="profile.html">Jhon Smith<span><span>+91-9609412418</span></span></a>
                                            </h2>
                                        </td>
                                        <td>Monthly</td>
                                        <td>15 Dec 2022, 06:12 PM</td>
                                        <td>15 Dec 2022, 06:12 PM</td>
                                        <td><i class="fa-solid fa-indian-rupee-sign"></i>&nbsp; 1,862</td>
                                        <td><span class="badge badge-pill bg-success-light">Active</span></td>
                                        <td class="d-flex align-items-center">
                                            <a href="add-invoice.html" class="btn btn-greys me-2"><i class="fa fa-eye me-1"></i> View Invoice</a>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td><strong>INVNo002</strong></td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a></a>
                                                <a href="profile.html">Johnny Charles <span><span>+91-9609412418</span></span></a>
                                            </h2>
                                        </td>
                                        <td>Half-Yearly</td>
                                        <td>15 Dec 2022, 06:12 PM</td>
