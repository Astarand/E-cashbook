                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="firmlist" role="tabpanel">
										...
										<input type="hidden" name="id" id="caId" value="{{ $ca->id }}">
										@csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="name" name="name" value="{{ $ca->name}}" class="form-control" placeholder="Enter CA Name">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label>CA Email</label>
                                                    <input type="email" id="email" name="email" readonly value="{{ $ca->email}}" class="form-control" placeholder="Enter Email Address">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label>Phone Number</label>
                                                    <input type="text" id="phone" name="phone" value="{{ $ca->phone}}" class="form-control" placeholder="Enter Phone Number">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label>Address Line 1</label>
                                                    <input type="text" id="addr_one" name="addr_one" value="{{ $ca->addr_one}}" class="form-control" placeholder="Enter Address Line 1">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label>Address Line 2</label>
                                                    <input type="text" id="addr_two" name="addr_two" value="{{ $ca->addr_two}}" class="form-control" placeholder="Enter Address Line 2">
                                                </div>
                                            </div>
											<div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
													...
													<select class="form-control select-style" name="ca_state" id="state" onChange="changeState(this);">
														...
														@foreach($states as $k=>$state)
															<option value="{{ $state->id }}" <?php echo ($state->id==$ca->state_id)? "selected":"" ?>>{{ $state->name }}</option>
														@endforeach
													</select>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
													...
													<select class="form-control select-style" name="ca_city" id="city">
														...
														<option value="{{ $city->id }}" <?php echo ($city->id==$ca->city_id)? 'selected="selected"':"" ?>>{{ $city->name }}</option>
														@endforeach
													</select>
                                                </div>
                                            </div>                                            
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label>Pincode</label>
                                                    <input type="text" id="pincode" name="pincode" value="{{ $ca->pincode}}" class="form-control" placeholder="Enter Pincode">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="add-customer-btns text-end">
                                            <button type="submit" class="btn customer-btn-save">Edit CA</button>
                                        </div>
										</form>
                                    </div>
