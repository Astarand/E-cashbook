...
{{--                        </div>--}}
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="asset_sl_no" id="asset_sl_no" placeholder="Enter Serial Number">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="warranty_period" id="warranty_period" placeholder="Warranty Period">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Opening Stocks(Units)</label>
                                <input type="text" class="form-control" name="opening_stock" id="opening_stock" placeholder="Enter Opening Stocks">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Opening WDV IT's Act Wise</label>
                                <input type="number" class="form-control" name="opening_it_act" id="opening_it_act" placeholder="0">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Opening WDV Company's Act Wise</label>
                                <input type="number" class="form-control" name="opening_comp_act" id="opening_comp_act" placeholder="0">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Description Till WDV IT's Act Wise</label>
                                <input type="text" class="form-control" name="desc_it" id="desc_it" placeholder="">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Description Till WDV Company's Act Wise</label>
                                <input type="text" class="form-control" name="desc_comp" id="desc_comp" placeholder="">
                            </div>
                        </div>
                    </div>
                </div>
