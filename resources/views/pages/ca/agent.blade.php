                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a></a>
                                                <a href="{{ url('/agent-view/'.base64_encode($agent->id)) }}">{{ $agent->agent_name }} <span><span class="__cf_email__" data-cfemail="a9c3c6c1c7e9ccd1c8c4d9c5cc87cac6c4">[email&#160;protected]</span></span></a>
                                            </h2>
                                        </td>
