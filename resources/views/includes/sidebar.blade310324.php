    ...
    <div class="sidebar-inner slimscroll">
        ...
        <div id="sidebar-menu" class="sidebar-menu">
           ...
           <!-- <ul>
            ...
            <ul>
                <li>
                    <a href="{{ url('/statutory') }}"><i class="fe fe-check-square"></i> <span>Compliances / statutory</span></a>
                </li>
            </ul>
        ...
        @if (Auth::user()->u_type==1 && Auth::user()->isCaActive==1)<!-- && Auth::user()->isCaActive==1 this will only visibale when CA login  -->
            <div id="sidebar-menu" class="sidebar-menu">
                ...
                <ul>
                    <li><a href="{{ url('/caprofile') }}"> <i class="fe fe-pocket"></i><span>Firm Profile</span></a></li>
                </ul>
                <ul>
