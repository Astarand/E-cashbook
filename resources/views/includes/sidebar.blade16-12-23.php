<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-inner slimscroll">
        ...
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            <ul>
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="sales-invoice"><i class="fe fe-file-plus"></i> <span>Sales Invoice</span></a></li>
                        <li><a href="sales-credit-debit"><i class="fe fe-file-text"></i> <span>Credit-Debit Notes</span></a></li>
                    </ul>
                </li>
            </ul>
            <ul>
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="purchase-invoice"><i class="fe fe-file-plus"></i> <span>Purchase Invoices</span></a></li>
                        <li><a href="#"><i class="fe fe-file-minus"></i> <span>Payment Out</span></a></li>
                        <li><a href="purchase-credit-debit"><i class="fe fe-file-text"></i> <span>Credit-Debit Notes</span></a></li>
                    </ul>
                </li>
            </ul>
            <ul>
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="assets"><i class="fe fe-grid"></i> <span>Assets Details</span></a></li>
                        <li><a href="asset-voucher"><i class="fe fe-feather"></i> <span>Assets Voucher</span></a></li>
                    </ul>
                </li>
            </ul>
            <ul>
                <li>
                    <a href="payment"><i class="fe fe-arrow-down-right"></i> <span>Payments</span></a>
                </li>
            </ul>
            <ul>
                <li>
                    <a href="expenses"><i class="fe fe-arrow-up-right"></i> <span>Expenses</span></a>
                </li>
            </ul>
            <ul>
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="banks"><i class="fe fe-clipboard"></i> <span>Bank Accounts</span></a></li>
                        <li><a href="loans"><i class="fe fe-clipboard"></i> <span>Loan Accounts</span></a></li>
                        <li><a href="cash"><i class="fe fe-clipboard"></i> <span>Cash Management</span></a></li>
                    </ul>
                </li>
            </ul>
            <ul>
            ...
            <ul>
                <li>
                    <a href="statutory"><i class="fe fe-check-square"></i> <span>Statutory Filling</span></a>
                </li>
            </ul>
        ...
        @if (Auth::user()->u_type==1)<!-- this will only visibale when CA login  -->
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    <li><a href="{{ url('/cahome') }}"> <i class="fe fe-pocket"></i><span>CA Dashboard</span></a></li>
                </ul>
                <ul>
                ...
                <ul>
                    <li><a href="#"> <i class="fe fe-pocket"></i><span>Statutory Filling Report</span></a></li>
                </ul>
                <ul>
