    ...
    <div class="sidebar-inner slimscroll">
        ...
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            @if (Auth::user()->u_type==3)
				...
				<ul>
					<li><a href="{{ url('/ca-requested') }}"><i class="fa fa-user-plus"></i><span>Requested CA</span></a></li>
				</ul>
				@endif
				@if (in_array('Our_CA', $permission))
				<ul>
					<li><a href="{{ url('/our-ca') }}"><i class="fa fa-users"></i><span>Our CA</span></a></li>
				</ul>
				@endif
				...
				@endif
                <ul>
                    <li><a href="{{ url('/business') }}"><i class="fa fa-university"></i> <span> Business & Earnings </span></a></li>
                </ul>
                <ul>
                    <li><a href="{{ url('/ca-reminder') }}"><i class="fa fa-bell"></i> <span> Reminder</span></a></li>
                </ul>
