...
Route::group(['middleware' => ['auth']],function(){
	...
	Route::get('/view-bank-transaction/{tranId}', 'CashController@view_transaction');
	Route::get('/edit-bank-transaction/{tranId}', 'CashController@edit_transaction');
	Route::post('/update_transaction', 'CashController@update_transaction');
