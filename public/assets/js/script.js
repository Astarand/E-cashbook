(function($) {
    ...
    $(document).ready(function() {
        ...
        $('#sidebar-menu').on('click', 'a', function(e) {
            ...
            if ($subMenu.length) {
                ...
                if (!$(this).hasClass('subdrop')) {
                    // Close all open submenus and remove 'subdrop' class
                    $('#sidebar-menu .subdrop').next('ul:visible').slideUp(350);
        ...
        // Trigger a click on the initially active submenu link
        $('#sidebar-menu ul li.submenu a.active').addClass('subdrop').next('ul').show();
    });
    ...
    $(document).ready(function() {
        // Check if an element with class 'win-maximize' exists
        if ($('.win-maximize').length > 0) {
            // Attach a click event handler to the 'win-maximize' elements
